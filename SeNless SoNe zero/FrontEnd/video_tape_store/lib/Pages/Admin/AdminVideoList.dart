...
import 'package:video_tape_store/Pages/home/TeamProfilePage.dart';
    ...
    if (confirmed ?? false) {
      ...
      try {
        ...
        final response = await http.delete(
          Uri.parse("${ApiConstants.baseUrl}/videotapes/${tape.id}"),
          headers: {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Manage Video Tapes',
        ...
        return Card(
          ...
          child: ListTile(
            ...
            leading: ClipRRect(
              ...
              child: Image.network(
                Platform.isAndroid
                    ? 'http://10.0.2.2:3000${tape.imageUrls.first}'
                    : 'http://localhost:3000${tape.imageUrls.first}',
                width: 60,
                height: 80,
                fit: BoxFit.cover,
              ),
            ),
            title: Text(tape.title, style: AppTextStyles.bodyMedium),
            subtitle: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const SizedBox(height: 4),
                Text('\$${tape.price.toStringAsFixed(2)}',
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () async {
                    ...
                    print("Returned from edit page, fetching data...");
                    await _fetchVideoTapes();
                  },
                ),
                IconButton(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text('No video tapes found', style: AppTextStyles.headingSmall),
