...
class _HomePageState extends State<HomePage> {
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      ...
      elevation: 0,
      title: const Text(AppStrings.appName, style: AppTextStyles.headingMedium),
      actions: [
        IconButton(
                ...
                return Container(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(tape.title,
                            style: AppTextStyles.headingSmallCarousel),
                        const SizedBox(height: AppDimensions.marginSmall),
                        Row(
                          children: [
                            Text('\$${tape.price.toStringAsFixed(2)}',
                                style: AppTextStyles.priceTextCarousel),
                            const Spacer(),
                            if (tape.rating > 0)
                              Row(
                                children: [
                                  ...
                                  Text(tape.rating.toStringAsFixed(1),
